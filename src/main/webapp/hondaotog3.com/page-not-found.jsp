...
<body>
    ...
    <section class="pathpage group">
        <div class="container group">
            ...
            <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                    ...
                    <a title="Trang không tìm thấy" itemtype="https://schema.org/Thing" itemprop="item" href="page-not-found.jsp"><span itemprop="name"><span data-lang='bc_page_not_found'>Trang không tìm thấy</span></span></a>
    ...
    <section class="main group">
        ...
        <a class="btn btn-default" href="index.jsp" title="Trở về trang chủ" data-lang="error_button">← TRỞ VỀ TRANG CHỦ</a>
    </div>
        </div>
    </section>
    <section>
