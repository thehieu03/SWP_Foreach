<%-- 
    Document   : header
    Created on : 26 Sept 2024, 03:03:26
    Author     : hieun
--%>
...
<html>
  ...
  <link href="../css_login/vender.css" rel="stylesheet" type="text/css"/>
  <link rel="stylesheet" href="css/vendor.css">
  <link rel="stylesheet" type="text/css" href="style.css">
  <link href="../css_login/css_header.css" rel="stylesheet" type="text/css"/>
  ...
  <header id="header" class="site-header text-black">
    ...
    <nav id="header-nav" class="navbar navbar-expand-lg">
      <div class="container-lg" style="background:red;color:black">
            ...
            <ul id="navbar" class="navbar-nav fw-bold justify-content-end align-items-center flex-grow-1">
              <li class="nav-item dropdown">
                <a class="nav-link me-5 active dropdown-toggle border-0" href="#" data-bs-toggle="dropdown"
                  aria-expanded="false">Cơ sở</a>
                <ul class="dropdown-menu fw-bold">
                  <li>
                    <a href="index.html" class="dropdown-item">Hà Nội</a>
                  </li>
                  <li>
                    <a href="index.html" class="dropdown-item">Hồ Chí Minh</a>
                  </li>
                </ul>
              </li>
              <li class="nav-item">
                <a class="nav-link me-5" href="#">Bảng giá xe</a>
              </li>
              ...
              <li class="nav-item">
                <a class="nav-link me-5" href="index.html">Bảng giá xe</a>
              </li>
              <li class="nav-item">
                <a class="nav-link me-5" href="#">Đăng kí lái thử</a>
              </li>
            </ul>
          </div>
        </div>
